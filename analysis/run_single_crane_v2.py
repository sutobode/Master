...
Methods: Original pretrained model (greedy) + 4 published heuristics.
ZeroShot(C=1) is numerically identical to the original model by construction
(verified to 0.00%), so it is not run separately.
